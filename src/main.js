...
const enemyWavePalettes = [
  {
    ...
    armorColor: 0xb82931,
    coatColor: 0x9e1823,
    deepCoatColor: 0xf2e7d8,
    rubberColor: 0x171111,
    harnessColor: 0x3c211a,
    decalsColor: 0xffd4a3,
    visorColor: 0xffc0ad,
    bodyColor: 0xa6232b,
    jacketColor: 0x8f1822,
    pantsColor: 0x171111,
    bootColor: 0x120d0d,
    skinColor: 0x6f4736,
    armorPanel: characterWavePanels.redArmor,
    coatPanel: characterWavePanels.redArmor,
    deepCoatPanel: characterWavePanels.orangeRaincoat,
    rubberPanel: characterWavePanels.rubberGloves,
  ...
  },
  {
    ...
    armorColor: 0x21b76a,
    coatColor: 0x078763,
    deepCoatColor: 0x08120e,
    rubberColor: 0x071014,
    harnessColor: 0x193621,
    decalsColor: 0xffd76d,
    visorColor: 0xd6ffd8,
    bodyColor: 0x0c7655,
    jacketColor: 0x078763,
    pantsColor: 0x0b1418,
    bootColor: 0x081014,
    skinColor: 0x4f3a2b,
    armorPanel: characterWavePanels.greenArmor,
    coatPanel: characterWavePanels.greenArmor,
  ...
  },
  {
    ...
    armorColor: 0x6f3bb3,
    coatColor: 0x52247e,
    deepCoatColor: 0x100915,
    rubberColor: 0x120d15,
    harnessColor: 0x271637,
    decalsColor: 0xd8b7ff,
    visorColor: 0xffb0f7,
    bodyColor: 0x4c2373,
    jacketColor: 0x52247e,
    pantsColor: 0x120d18,
    bootColor: 0x100b14,
    skinColor: 0x4c364e,
    armorPanel: characterWavePanels.violetArmor,
    coatPanel: characterWavePanels.violetArmor,
    deepCoatPanel: characterWavePanels.meshSuit,
    rubberPanel: characterWavePanels.rubberGloves,
    visorPanel: characterWavePanels.magentaVisor,
    accent: 0xb56bff,
  ...
  },
  {
    ...
    armorColor: 0xf1efe4,
    coatColor: 0xf7f3e8,
    deepCoatColor: 0x08080a,
    rubberColor: 0x151719,
    harnessColor: 0x151515,
    decalsColor: 0xffed9c,
    visorColor: 0xfff1a6,
    bodyColor: 0xf0eadc,
    jacketColor: 0xf7f3e8,
    pantsColor: 0xf1eadb,
    bootColor: 0xf6f0df,
    skinColor: 0x6a4d3a,
    armorPanel: characterWavePanels.whiteArmor,
    coatPanel: characterWavePanels.whiteArmor,
    deepCoatPanel: characterWavePanels.blackHelmet,
    rubberPanel: characterWavePanels.rubberGloves,
    visorPanel: characterWavePanels.cyanVisor,
    accent: 0xffd76d,
    secondaryAccent: 0xff2f6d,
  ...
  },
  {
    ...
    armorColor: 0xb47b2c,
    coatColor: 0xa56a24,
    deepCoatColor: 0x0e0905,
    rubberColor: 0x0c120e,
    harnessColor: 0x2b1a0b,
    decalsColor: 0xffc36d,
    visorColor: 0xffd9a5,
    bodyColor: 0x8d5520,
    jacketColor: 0xa56a24,
    pantsColor: 0x0a150e,
    bootColor: 0x07110b,
    skinColor: 0x7a5538,
    armorPanel: characterWavePanels.orangeArmor,
    coatPanel: characterWavePanels.orangeArmor,
    deepCoatPanel: characterWavePanels.blackHelmet,
    rubberPanel: characterWavePanels.rubberGloves,
    visorPanel: characterWavePanels.magentaVisor,
    accent: 0xffb23a,
  ...
  },
  {
    ...
    armorColor: 0x244f82,
    coatColor: 0x1f5b98,
    deepCoatColor: 0x09090a,
    rubberColor: 0x060708,
    harnessColor: 0x14273a,
    decalsColor: 0xe8eef4,
    visorColor: 0xdff4ff,
    bodyColor: 0x2b5d91,
    jacketColor: 0x1f5b98,
    pantsColor: 0x152c46,
    bootColor: 0x030405,
    skinColor: 0x6f4b34,
    armorPanel: characterWavePanels.cyanArmor,
    coatPanel: characterWavePanels.cyanArmor,
    deepCoatPanel: characterWavePanels.blackHelmet,
    rubberPanel: characterWavePanels.rubberGloves,
    visorPanel: characterWavePanels.cyanVisor,
    accent: 0x74bfff,
  ...
  },
  {
    ...
    armorColor: 0x2c6da8,
    coatColor: 0x245b8f,
    deepCoatColor: 0x08090d,
    rubberColor: 0x071019,
    harnessColor: 0x18293b,
    decalsColor: 0xe5edf5,
    visorColor: 0x9fd7ff,
    bodyColor: 0x2a5d90,
    jacketColor: 0x245b8f,
    pantsColor: 0x1e4d7b,
    bootColor: 0x061019,
    skinColor: 0x64462f,
    armorPanel: characterWavePanels.cyanArmor,
  ...
  {
    name: "粉色夜場新人",
    gltfPanel: characterWavePanels.magentaVisor,
    gltfColor: 0xffe7f5,
    gltfRoughness: 0.2,
    gltfMetalness: 0.28,
    metalColor: 0xffa6d6,
    armorColor: 0xff4fa3,
    coatColor: 0xdb2f83,
    deepCoatColor: 0x130812,
    rubberColor: 0x120b10,
    harnessColor: 0x40122f,
    decalsColor: 0xffb4df,
    visorColor: 0xffb3f5,
    bodyColor: 0xa51f62,
    jacketColor: 0xdb2f83,
    pantsColor: 0x151016,
    bootColor: 0x100a10,
    skinColor: 0x6a4156,
    armorPanel: characterWavePanels.violetArmor,
    ...
    const waistChain = new THREE.Mesh(
      new THREE.TubeGeometry(
        new THREE.CatmullRomCurve3([
          new THREE.Vector3(-0.33, 0.88, 0.43),
          new THREE.Vector3(-0.12, 0.78, 0.5),
          new THREE.Vector3(0.1, 0.79, 0.5),
          new THREE.Vector3(0.33, 0.88, 0.43),
        ]),
        18,
        0.01,
